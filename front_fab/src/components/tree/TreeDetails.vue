<template>
        ...
        <button class="pointer my btn-share" @click="makePrivate" v-if="this.user_tree.active == 0">
            Make private
        </button>
        <button class="pointer my btn-share" @click="makePublic" v-if="this.user_tree.active == 1" >
            Share with friends
        </button>
        </div>
