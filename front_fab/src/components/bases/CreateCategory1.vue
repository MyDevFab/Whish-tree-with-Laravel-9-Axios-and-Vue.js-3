<template>
  <div style="display: flex; justify-content: center; align-items: center; margin-bottom: 20px; margin-top: 20px;">
      <form @submit.prevent="createCategory" @submit="$emit('NewCategory', category)">
            <div class="mb-3">
                <input v-model="name"  type="text" class="form-control" id="exampleInputEmail1" placeholder="eg. Wellbeing" aria-describedby="emailHelp">
            </div>
